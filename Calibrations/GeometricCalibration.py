...
class GeometricCalibration:
    def __init__(self, cam, projector, imgFile, imgUndistortFile, intrinsicFile, checker_pattern=(23, 7), checker_size=0.01, checker_pixels=60,
    ...
    def calibrate(self):
        ...
        img_undistort = cv2.imread(self.imgUndistortFile)
